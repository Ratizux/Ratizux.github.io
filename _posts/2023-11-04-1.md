...
简单玩一下 RISC-V Vector Extension。关于 RVV 和 x86/ARM SIMD 的区别，这里还不需要过度关注，感兴趣的话可以去读些[科普文章](https://medium.com/swlh/risc-v-vector-instructions-vs-arm-and-x86-simd-8c9b17963a31)。
